...
export class DatabaseStorage implements IStorage {
  ...
  async getEarningsForCreator(creatorId: number): Promise<EarningsStats> {
    // Performance Optimization: Use SQL aggregations (SUM, COUNT, FILTER) to calculate
    // stats at the database level instead of fetching and processing all bookings in memory.
